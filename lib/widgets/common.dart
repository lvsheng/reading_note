...
Widget buildConfirmButton(VoidCallback? onPressed, {double widthFactor = 1.0, EdgeInsets? padding}) => buildButton(onPressed, material.Icons.check, CupertinoColors.activeBlue, widthFactor: widthFactor, padding: padding);

Widget buildButton(VoidCallback? onPressed, IconData icon, Color color, {double widthFactor = 1.0, EdgeInsets? padding}) => CupertinoButton(
  onPressed: onPressed,
  padding: padding,
  child: Container(
    height: buttonHeight,
